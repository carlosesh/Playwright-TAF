...
const selectors = {
	...
	categories: {
		...
		[Categories.IT_BAGS]: `//a[contains(@class, 'category-item')]//p[contains(., 'LTK Find')]`,
		[Categories.BABY]: `//a[contains(@class, 'category-item')]//p[contains(., 'LTK Find')]`,
		[Categories.BUMP]: `//a[contains(@class, 'category-item')]//p[contains(., 'LTK Find')]`,
		[Categories.KIDS]: `//a[contains(@class, 'category-item')]//p[contains(., 'LTK Find')]`,
		[Categories.FAMILY]: `//a[contains(@class, 'category-item')]//p[contains(., 'LTK Find')]`,
		[Categories.MENS]: `//a[contains(@class, 'category-item')]//p[contains(., 'LTK Find')]`,
		[Categories.WEDDINGS]: `//a[contains(@class, 'category-item')]//p[contains(., 'LTK Find')]`,
		[Categories.EUROPE]: `//a[contains(@class, 'category-item')]//p[contains(., 'LTK Find')]`,
		[Categories.BRASIL]: `//a[contains(@class, 'category-item')]//p[contains(., 'LTK Find')]`,
	}
} as const;
